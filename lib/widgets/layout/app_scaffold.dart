...
class KScaffold<T> extends ConsumerWidget {
  ...
  static AppBarBuilderArgs _appBarBuilder = (title, subtitle, onBackButtonPressed) => const SizedBox();
  static set appBarBuilderArgs(AppBarBuilderArgs args) => _appBarBuilder = args;
    ...
    return PopScope<T>(
      ...
      child: AnnotatedRegion(
        ...
        child: _AppScaffoldBody(
          ...
          defaultAppBar: _appBarBuilder(
            title,
            subtitle,
            (context) => onBackButtonPressed == null ? Navigator.pop(context) : onBackButtonPressed?.call(),
          ),
        ),
      ),
    );
...
// SystemUiOverlayStyle _evalkSystemOverlayStyle(ThemeData theme, bool isDarkMode) {
